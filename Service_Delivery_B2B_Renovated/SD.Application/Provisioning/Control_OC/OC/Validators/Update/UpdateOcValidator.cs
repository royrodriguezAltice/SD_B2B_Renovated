...
namespace SD.Application.Provisioning.Control_OC.OC.Validators.Update
{
	public class UpdateOcValidator : AbstractValidator<UpdateOC>
	{
		public UpdateOcValidator() 
		{
